...
<head>
    <meta charset="utf-8">
    <title>Управление направлениями подготовки</title>
</head>
<body class="body">
...
<div id="update_popup" class="parent_popup">
    <div class="popup-big">
        <div class="popup-form" style="height:300px;">
            ...
            <form action="/updateDirection" autocomplete="off" method="POST">
...
<div id="insert_popup" class="parent_popup">
    <div class="popup-big">
        <div class="popup-form" style="height:300px;">
            ...
            <form action="/insertDirection" autocomplete="off" method="POST">
                <div class="center-div-update" style="height:150px;">
                    <table class="popup-update-table" style="width: 800px;">
                        <tr>
                            <td style="width: 150px">Код направления</td>
...
<div id="delete_popup" class="parent_popup">
    <div class="popup">
        <form action="/deleteDirection" method="POST" id="form-popup1" class="popup-form" style="height:140px;">
...
<div class="center-block">
    <h2>Управление направлениями подготовки</h2>
    <table class="center-table">
        ...
        <c:forEach items="${directionList}" var="direction">
                <tr>
                    ...
                    <td>
                        <input type="button" class="button red" onclick="deleteRow(${direction.idDirection});" value="Удалить"/>
                        <input type="button" class="button blue" onclick="updateRow(${direction.idDirection}, '${direction.number}', '${direction.name}');" value="Редактировать"/>
                    </td>
                </tr>
        </c:forEach>
    </table>
